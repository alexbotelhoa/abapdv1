...
if (isset($_POST['add'])) {
    ...
    mysqli_query($sql, $con) or die ("<font style=Arial color=red>Houve um erro na gravação dos dados</font>");
    mysqli_close();
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; vertical-align: middle; font-size: 12px; font-family: Verdana, Arial, Helvetica, sans-serif">
                    <tr>
                        ...
                        <td width="455"><input type="text" name="desc" maxlength="300" size="60" value="<?php echo $desc ?>" readonly></td>
...
<br>
    <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; vertical-align: middle; font-size: 12px; font-family: Verdana, Arial, Helvetica, sans-serif">
        <?php
            ...
            $consulta=mysqli_query($sql, $con); $valor_total_venda="0";$valor_total_imposto="0";$valor_total_reposicao="0";$valor_total_lucro="0";
    ...
    <form name="form" action='venda.php' method='POST'>
        ...
        <?php
            //echo time()." | ".$valor_total_venda." | ".$valor_total_reposicao." | ".$valor_total_imposto." | ".$valor_total_lucro;
        ?>
        <table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse">
            <tr height="40">
